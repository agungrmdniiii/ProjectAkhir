...
<div class="container">
    ...
    <form action="{{ route('pemilik.pengajuanhama.store') }}" method="POST" id="pengajuanForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" name="lokasi" class="form-control" id="lokasi" required readonly
                   placeholder="Gunakan tombol 'Deteksi Lokasi Otomatis' atau 'Pilih di Peta' untuk menentukan lokasi">
            <small class="form-text text-muted">Lokasi harus ditentukan menggunakan deteksi otomatis atau pilih di peta</small>
        </div>
