...
<head>
    ...
    <title>Kelola Rumah Warga</title>
    ...
    <style>
        ...
        .btn-group button {
            font-size: 0.700rem; /* Ukuran font yang lebih kecil */
            padding: 7px 40px; /* Padding lebih besar untuk tombol */
            height: 45px; /* Tinggi tombol lebih besar */
            line-height: 1.6;
        }
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <div class="btn-group">
                        ...
                        <form action="javascript:void(0);" method="POST" enctype="multipart/form-data" class="d-inline">
                            @csrf
                            <button class="btn btn-success" type="button" onclick="showFeatureComingSoon()">Download Template</button>
                        </form>
                        <form action="javascript:void(0);" method="POST" enctype="multipart/form-data" class="d-inline">
                            @csrf
                            <button class="btn btn-success" type="button" onclick="showFeatureComingSoon()">export Data</button>
                        </form>
                        <form action="javascript:void(0);" method="POST" enctype="multipart/form-data" class="d-inline">
                            @csrf
                            <button class="btn btn-success" type="button" onclick="showFeatureComingSoon()">Import Data</button>
                        </form>
                    </div>
                </div>  
                <div class="card-body">
